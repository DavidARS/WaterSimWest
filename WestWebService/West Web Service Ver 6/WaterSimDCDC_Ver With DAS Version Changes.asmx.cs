...
// EDN EDIT
        ...
        public string WaterSimVersion()
        {
            ...
            try
            {
                ...
                if (MyWSim != null)
                {
// EDIT FROM DAS VERSION 6 14 2019
...
//                Extended_Parameter_Documentation EPD = new Extended_Parameter_Documentation(WSim.ParamManager);
                                    ...
                                    foreach (string Fldstr in FldsToFetch)
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            if (MP != null)
                                            {
												...
												// Modified based on DAS version 6 14 2019
												// NOT SURE WHY THIS WAS ALL DONE SO DIFFERENTLY IN DAS Code
												...
												JSON_NameValuePair JS_ScaleValues_Pair = new JSON_NameValuePair("WEBSCVAL", JS_ScaleValues);	
                                                JSON_NameValuePair JS_ScaleStrs_Pair = new JSON_NameValuePair("WEBSCL", JS_ScaleStrs);
        ...
        public string RunWaterSim_Results(string inputJsonArray, string outputJsonArray, ref string Status, ref string Password, ref string User, ref string IPAddress)
        {
            ...
            lock (RunModelThreadLock)
            {
                ...
                if (MyWSim != null)
                {
// EDIT ADDED FROM DAS, WHY WAS THIS ADDED, is this a base call or something new??  Why would the model not be valid?
                     bool IsValid = MyWSim.ValidModel;
					if (isValid)
{
// EDN EDIT NEED TO UNDERSTAND THIS!!!!!!
...
// EDIT FROM DAS VERSION WHAT IS THIS INValid???
