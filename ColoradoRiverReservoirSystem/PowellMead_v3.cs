    ...
    public class Powell_mead : COReservoirs
    {
        ...
        public override void Flows(int year)
        {
            ...
            if (year <= defaultYearCO)
            {
                ...
                //COflow = COriver.CORiverTrace[year - 2000];
                //COInFlow = COriver.CORiverInFlow[year - 2000];
        ...
        internal void ReturnFlowsEstimate()
        {
           ...
           // COflow = COriverTraceArray[LoopCount];
            ...
            COflow = COriver.COriverTraceArray[LoopCount];
            COInFlow = COriver.COriverInFlowArray[LoopCount];
