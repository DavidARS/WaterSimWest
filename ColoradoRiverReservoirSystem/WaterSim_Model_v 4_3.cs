...
namespace WaterSimDCDC.Generic
{
    ...
    public class WaterSimModel
    {
        ...
        //
        DataClassLCLU FDataLCLU;
        //
        DataClassTemperature FDataTemperature;
        ...
        public WaterSimModel(string DataDirectoryName, string TempDirectoryName)
        {
            ...
            string UnitDataFielname = "West Regions USGS with Colorado Ver 5.csv";
            ...
            // 09.03.20 das
            WaterSimDCDC.Generic.WaterSimModel WS = (this as WaterSimModel);
            // 09.03.20 das stop
            // EDIT END 2 13 18
            try
            {
                ...
                COS = new COriverModel(DataDirectoryName + "\\" + COdata + "\\", TempDirectoryName);
        ...
        //    int[] iRWM = new int[ModelCount];
        //    double G = 0;
        //    iRWM = this.geti_ReclaimedWaterManagement();
        ...
        //        {
        //            gray = management[i] * G;
        //            PCTgray = gray / GrayWater[i];
        //        }
        //        else
        //            Temp = iRWM[i];
        //        if (gray > 0) { result = (int)PCTgray; }
        //        else result = (int)Temp;
        //        iGray[i] = result;
        //    }
        //   //this.seti_Effluent(iGray);
        //    seti_ReclaimedWaterManagement(iGray);
        //}
        //
        ...
        // ------------------------------------------------------
        // 09.03.20 das
        //public int seti_COriverTraceYearStart
        //{
        //    set { West.seti_COriverTraceStartYear = value; }
        //}

        // 09.03.20 das
        private int _COtraceStartyr = 1920;
        public int COriverTraceStartYr
        {
            get { return _COtraceStartyr; }
            set { _COtraceStartyr = value; }
        }
        public int geti_COriverTraceStartYear()
        {
            return _COtraceStartyr; 
        }
