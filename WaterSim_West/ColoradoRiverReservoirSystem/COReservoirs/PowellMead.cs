...
namespace WaterSimDCDC.Generic
{
    public class Powell_mead : COReservoirs
    {
        ...
        public Powell_mead(string DataDirectoryName, string CORiverFile, string ICSdataFile)
        {
            ...
            FUnitData = new UnitData(DataDirectoryName, CORiverFile);
        ...
        public Powell_mead(UnitData FUnitData)
        {
            FUDC = FUnitData;
            Initialize();
        }
        ...
        public Powell_mead(UnitData FUnitData, UnitData2 FUnitData2)
        {
            FUDC = FUnitData;
            FUBD = FUnitData2;
            Initialize();
       ...
       public override void UpStream(int year)
        {
            ...
            //IcsTotal = (IcsArizona + IcsCalifornia + IcsNevada + IcsTON + IcsSNWA + IcsOther) * Constants.acreFeetToMAF; ;
        }
        ...
        public void ChooseTrace()
        {
           
            int startTrace = 1950;
            int year = startTrace;
             do {
                double flow = FUDC.FastFlow(year);
                COriverTraceArray[year] = flow;
      ...
      public override void Flows(int year)
        {
            ...
            COflow = temp * FUDC.FastFlow(year) * (1 / Constants.oneMillion);
        ...
        internal double IntentionallyCreatedSurplus(int year)
        {
            double result = 0;
            //double ICS = 0;
            // Abbreviaitons : IID- Imperial Irrigation District

            // Reclamation - Colorado River Accounting and Water Use Report: AZ, CA, NV 2012
            ...
            //        IcsNevada = 0;
            //        // CA
            //        ICS = 100864 - 5191; // minus delivery to IID
            //        IcsCalifornia = ICS;
            //        break;
            ...
            //        // CA
            //        ICS = 179677;
            //        IcsCalifornia = 179677;
            //        // NV 
            //        ICS += 31422 + 3198;
            //        IcsNevada = 31422 + 3198;
            //        break;
            //    case 2013:
            //        ICS = 33200 - 4953; // NV 
            //        IcsNevada = 33200 - 4953;
            //        break;
            //    case 2014:
            //        // Cali
            //        ICS = 18867;
            ...
            //        ICS = 10080; // Tohono 'Oodham Nation (TON)
            //        ICS += 15000; // Southern Nevada Water Authority (SNWA) - Virgin River offsets
            //        IcsTON = 10080;
            //        IcsSNWA = 15000;
            //        // BureauOfRec
            //        // Cali
            ...
            //        // Cali
            //        ICS += 18733 - 1458;
            //        IcsCalifornia = 18733 - 1458;
            //        // AZ
            //        ICS += 0;
            //        IcsArizona = 0;
            //        // NV
            //        ICS += 25030 - 4491;
            //        IcsNevada = 25030 - 4491;
            //        // SNWAS - Virgin River Water
            //        ICS += 2580;
            //        IcsSNWA = 2580;
            ...
            //        // Cali
            //        ICS += 385132 - 19811;
            //        IcsCalifornia = 385132 - 19811;
            //        // AZ
            //        ICS += 23750;
            //        IcsArizona = 23750;
            //        // NV
            //        ICS += 56185 - 5479;
            //        IcsNevada = 56185 - 5479;
            //        // SNWAS - Virgin River Water
            //        ICS += 2580;
            //        IcsSNWA = 2580;
            ...
            //        break;
            //}
            result = (FICS.FastAZ_ICS(year) + FICS.FastCA_ICS(year) + FICS.FastIID_ICS(year) + FICS.FastNV_ICS(year)
                + FICS.FastSNWA_ICS(year) + FICS.FastNVOther_ICS(year) + FICS.FastTON_ICS(year) + FICS.FastGILA_ICS(year)) * Constants.acreFeetToMAF ;

            //result = (IcsArizona + IcsCalifornia + IcsNevada + IcsOther + IcsSNWA + IcsTON) * Constants.acreFeetToMAF;
            //   IcsTotal = (IcsArizona + IcsCalifornia + IcsNevada + IcsTON + IcsSNWA + IcsOther) * Constants.acreFeetToMAF; ;      
              return result;
        }
        //
