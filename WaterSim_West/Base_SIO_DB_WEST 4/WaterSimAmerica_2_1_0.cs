...
{
    public class WaterSimAmerica_X
    {
     //   CRF_Network_WaterSim_America WSA;
        //
         CRF_Unit_Network WSA;
        RateDataClass RDC;
        //  RateDataProcess RDP;
        ...
        public WaterSimAmerica_X(string DataDirectoryName, string TempDirectoryName)
        {
            State = FStateName;
            ...
            try
            {
                ...
                WSA = new CRF_Unit_Network (DataDirectoryName + "\\" + StateData, null, State);
