...
// VERSION 5_0_1
// This is the core WaterSim West Consumer Resource Framewoirk Model
// It is based on the ConsumerResourceModelFramework and WaterSimDCDC_API_WaterCRF classes and methods
// This is basically the West Regional Model, for which there will be one for each region managerd by 
// WaterSimDCDC_API_WaterWestRegion_Manager which defines the WaterSimManager class that is herited by WaterSim_SIO and WaterSim_DB
// This code is local to the WaterSim project becuase it is modified as changes or experiments are done to the WestModel
// 
// 
// Notes
...
namespace WaterSimDCDC.Generic
{
    ...
    public class WaterSimCRFModel
    {
        ...
        /// <summary>
        ///  Urban density proportions by density class
        /// </summary>
        ...
        //
        readonly ColoradoDesalExchangeClass CODE;
        // 08.31.21 das
        ...
        /*
         * This constructor has been superceeded in the move to a multiple regions, reference to rates data file is now managed by the
         * WaterSimModel which manages all regions rather than the WaterSimCRFModel which manages on one reagion
         * See public WaterSimModel(string DataDirectoryName, string TempDirectoryName) for data initilaization for all region models
        ///-------------------------------------------------------------------------------------------------
        ...
        */
        ...
        readonly double FMinUrbanLCLU = 0;
        double FUrbanLCLUChangeCoef = 1;
        // End Sampson Edits 06.27.18

        // edits das 09.20.21
        readonly double FMinUrbanDensity = 0;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public double FUrbanLD_LSFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanLD_TSFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanLD_SSFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanHD_SMFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanHD_WMFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanHD_MMFChangeCoef = 1;
        /// <summary>
        /// 
        /// </summary>
        public double FUrbanHD_HMFChangeCoef = 1;
        ...
        readonly double FMinWattPerPersonPercent = 0.50;
        readonly double FWattPerPersonChangeCoef = 1;
        ...
        readonly double FindEmpChangeCoef = 1;
        ...
        readonly double FIndMinGPEDPercent = 0.10;
        ...
        // *************************
        // Sampson edits 06.27.18
        readonly double FMinIndustryLCLU = 0;
        ...
        internal void RedundantPolicyCheck(string regionName)
        {
            ...
            if (0 < Geti_DesalPolicy())
            {
                ...
                FUnitData.GetValue(regionName, FldName, out int value, out string errMsg);
                int d = value;
        ...
        internal void ExchangePartner(string target)
        {
            ...
            FUnitData.GetValue(target, FldName, out int value, out string errMsg);
            double c = value;
        ...
        readonly double InitialSUrfaceAtDrought = 0;
        ...
        //
        // this is the field used for change coeeficient, and is the Max or Min values based on desired goal
        readonly double FUDChangeLimit = 1;
        // edit das 09.20.21
        ...
        void densityManagement(StreamWriter sw)
        {
            ...
            // ====================================================================================
            // THese are NOT going to change from the original code (setup)
        ...
        {
            // Limit in this case is the target value to achieve
            double result = 1;
        ...
        /// <summary>
        /// Quay, 3/3/2018.
        ///  This is based on the formula Forecast = Base_CU * ((1+GrowthRate)^(term))
        ///            The growth rate is adjusted based on a dampen function 
        /// </summary>
        /// <param name="Base_CU"></param>
        /// <param name="GrowthRateof_CU"></param>
        /// <param name="GrowthDamper"></param>
        /// <param name="period"></param>
        /// <param name="AdjustGrowth_CU"></param>
        ...
        public double Forecast_CU(double Base_CU, double GrowthRateof_CU, double GrowthDamper, double period, double AdjustGrowth_CU, double AdjustDamper)
        {
            ...
            {
                throw new Exception("in method Forecast_CU", ex);
        ...
        public double EstimateConsumerDemand(double ConsumerUnits, double GallonsPerUnit, double AdjustEfficiency, double AdjustDamper, double MinValue, double period)
        {
            ...
            try
            {
                ...
                double startValue = 1;
                double ModifyRate = AnnualExponentialChange(startValue, period, AdjustDamper, target);
            ...
            {
                throw new Exception("in method EstimateConsumerDemand", ex);
        ...
        void Urban_old()
        {
            ...
            if (invokePolicies)
            {
                ...
                {
                    throw new Exception("Void Urban_old()", ex);
                    // Ouch
                }
            }
            result = Convert.ToInt32(temp);
        ...
        public int urbanGPCD
        {
            get
            {
                ...
                catch (Exception ex) { throw new Exception("urbanGPCD", ex); }
        ...
        /// <summary>
        ///  Different demand models for urban, ind, and ag
        ...
        readonly double FAgProduction = 0;
        ...
        int agriculturalGPCD
        {
            get
            {
                ...
                catch (Exception ex) { throw new Exception("int agriculturalGPCD", ex); }
                return Convert.ToInt32(gpcd);
            }
        }
        ...
        void PowerWater_Old()
        {
            ...
            if (invokePolicies)
            {
                ...
                {
                    throw new Exception(" void PowerWater_Old()", ex);
                    // opps
                }
            }
            result = (int)temp;
        ...
        public int Calc_IndDemand(int theCurrentYear, int theStartYear, double modDemand)
        {
            ...
            {
                throw new Exception("Calc_IndDemand", ex); }
        ...
        public int CalculateNewPopulation_old(int theCurrentYear, int theStartYear)
        {
            ...
            catch (Exception ex) { throw new Exception("public int CalculateNewPopulation_old", ex); }
            //
            result = Convert.ToInt32(final);
            population = result;
            return result;
        ...
        double alterGrowthConservation(double institution, double ModifyGrowth)
        {
            ...
            catch (Exception ex) { throw new Exception("double alterGrowthConservation", ex); }
            return result;
        }
        double populationRatio
        {
            set
            {
                ...
                if (0 < OldPopulation)
                {
                    ...
                    catch (Exception ex) { throw new Exception("double populationRatio", ex); }
                }
                else
                {
                    temp = 0;
        ...
        /// <summary>
        ///  Switch to see if the user selected the use of graywater. Speeds up code
        /// </summary>
        ...
        /// <summary>
        ///  Checkto see if urban density change was selected from the UI. If not,
        ///  skips a bunch of code to speed things up
        /// </summary>
        ...
        /// <summary>
        /// THis is the property that controls the density change. Need to 
        /// see again how this is mapped.....02.01.22 das
        /// I keep forgetting....
        /// </summary>
        ...
        // ======================================================================
        // New code 02.01.22 das
        // Three NEW low density classes: LSF, TSF, SSF
        // Based on Denver Water Data (This could change)
        // LSF - Large single family
        // ==============================================
        double d_urbanLowDensityManagementLSF = 1.00;
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        public double UrbanLowDensityManagementLSF
        {
            get { return d_urbanLowDensityManagementLSF; }
        }
        double d_uldchangeLSF = 1.0;
        /// <summary>
        /// Large single family change in density (proportion)
        /// </summary>
        public double UrbanLowDensityChangeLSF
        {
            get { return d_uldchangeLSF; }
            set { d_uldchangeLSF = value; }
        }
        // ======================================================================
        // TSF - traditional single family
        double d_urbanLowDensityManagementTSF = 1.00;
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        public double UrbanLowDensityManagementTSF
        {
            get { return d_urbanLowDensityManagementTSF; }
        }
        double d_uldchangeTSF = 1.0;
        /// <summary>
        /// 
        /// </summary>
        public double UrbanLowDensityChangeTSF
        {
            get { return d_uldchangeTSF; }
            set { d_uldchangeTSF = value; }
        }
        // ======================================================================
        // SSF - small single family
        // =======================================
        double d_urbanLowDensityManagementSSF = 1.00;
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        public double UrbanLowDensityManagementSSF
        {
            get { return d_urbanLowDensityManagementSSF; }
        }
        double d_uldchangeSSF = 1.0;
        /// <summary>
        /// 
        /// </summary>
        public double UrbanLowDensityChangeSSF
        {
            get { return d_uldchangeSSF; }
            set { d_uldchangeSSF = value; }
        }
        // ==============================================================================
        ...
        /// <summary>
        ///  Atmospheric water management controller- whether happening or not
        /// </summary>
        ...
        /// <summary>
        ///  The percentage of the population that installs atmospheric water
        ///  systems 
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///  NOT used as near as I can tell
        /// </summary>
        ...
        public int GetFluxAllocated(string ResField, string ConsField)
        {
            ...
            if (theFlux != null)
            {
                ...
                {
                    throw new Exception("public int GetFluxAllocated", ex);
                    // ouch
                }
            }
            return result;
    ...
    static class utilities
    {
        ...
        /// <param name="TavHistorical"></param>
        /// <param name="TavScenario"></param>
        /// <returns></returns>
        ...
        #endregion
        #region NEW equations
        public static double Hyperbola(double factor, double time)
        {
        ...
        //
        // 09.21.21 das
        // I created this function  from Ray's ExponentialDecayCoef to simplify and rename because it estimates increases and decreases
        // in the response
        public static double ExponentialCoefficient(double TargetValue, double StartValue, double StartPeriod, double TargetPeriod)
        {
            double result = 0;
            double Limit = 0;
            Limit = TargetValue;
        ...
        public static double Forecast_CU(double Base_CU, double GrowthRateof_CU, double GrowthDamper, double period, double AdjustGrowth_CU, double AdjustDamper)
        {
            ...
            {
                throw new Exception("public static double Forecast_CU", ex);
                // Ouch Only thing going here is Math.Pow or Dampen Functions
            }
            return result;
        }
        ...
        public static double weightingByDemand(double Urban, double Ag, double Industry, double Power, int UD, int AD, int ID, int PD)
        {
            ...
            {
                throw new Exception("public static double weightingByDemand()", ex);
                // Ouch Only thing going here is Math.Pow or Dampen Functions
            }
            return result;
        }
