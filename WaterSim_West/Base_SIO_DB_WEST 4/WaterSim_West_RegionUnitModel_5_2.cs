...
namespace WaterSimDCDC.Generic
{
 ...
 // QUAY EDIT 9/12/18
       ...
       // double _maxReclaimed = 0;
        ...
        ///--------------------------------------------------------------
        //double d_drought = 1.00;
        double d_urbanDensityManagement = 0.00;
        public int geti_UrbanDensity()
        {
            int TempInt = Convert.ToInt32(d_urbanDensityManagement);
            return TempInt;
        }
        ///------------------------------------------------------------------
        ...
        /// <param name="value">    The value. </param>
        ///------------------------------------------------------------------
        public void seti_UrbanDensity(int value)
        {
            d_urbanDensityManagement = value;
        }
        // =======================================================================
