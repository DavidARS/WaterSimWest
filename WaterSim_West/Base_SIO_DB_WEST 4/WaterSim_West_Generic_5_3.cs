...
// VERSION 5_0_3
// 4/28/20
// This is the core WaterSim Consumer Resource Framework Model
// Notes
...
// 
// VERSION 5_0_0
// Moved to be included in API Source Files as link
// 
//  RULES/CONVENTIONS
...
namespace WaterSimDCDC.Generic
{
    ...
    public class WaterSimCRFModel
    {
        ...
        /// NOTE QUAY 4/28/20
        /// FOLLOW UP ON THIS
        /// Not sure where this code came from, is only used by constructor that passes tempreature data class.  This constructor is never used
        /// this constructor seems to be not finshed.  
        /// FDCTemoerature is used by he annual_Consumers method, but the end result has no effect on the model 
        /// It appears that a stream writer was intend here but this code has been commented out
        ...
        // NOTE QUAY 4/28/20 This method gets executed by Annual Consumers, but has no effect Neither
        // TheAddedDemand not _addedDemand are not used in any executed code I could find There are
        // some references commentd out in the parent definition of WaterCRFmode A Value is calculated
        // for TheAddedDemand using Utilities.TemperatureFunction_AddDemand
        // which seems to be based on a lot of analysis. I assume this was created by DAS
        // However, it is not clear to me how any of this works
        // ==============================================================================        /// <summary>
        ...
        // ==================================
        // NOTE QUAY 4/28/20
        // These two methods get executed, but actually do not do anything becuase TheAddedPowerPCT and _addedPower below are not used anywhere
        // FOLLOW UP ON THIS
...
*/
            ...
            // this one is for the surface water manaagement control
            double annualFactor = AnnualExponentialChange(1, SurfacePeriod, FSurfaceChangeCoefficient, FSurfaceChangeLimit);
            // Modify the Surfacewater control for the annualfactor of this year (ie fronm .01 year 1 to 1 in year end
            // EDIT QUAY 9/14/18
            // HUGE ERROR !!!! Forgot to include d_surfaceWaterControl
            tempBase = ( annualFactor * d_surfaceWaterControl)  * FBaseSurfaceWater;
            //tempBase = annualFactor * FBaseSurfaceWater;
            // // END EDIT
