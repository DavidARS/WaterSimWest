...
// END EDIT 
        ...
        protected override void initialize_ModelParameters()
        {
          ...
          //  WSim.ProcessManager.AddProcess(WM);
            ...
            //_pm.AddParameter(new ModelParameterClass(eModelParam.epP_COLORADO_USE_EXT_MODEL, "Use Colorado River External Model", "COL_EX", WestModel.UseColroadoExternal));
