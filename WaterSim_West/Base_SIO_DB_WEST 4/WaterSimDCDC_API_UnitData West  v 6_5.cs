...

{
    ...
    public static class UDI // 
    {
        ...
        //static public string[] ResourceListLabel = new string[] { "Surface Water", "Surface Water Lake ", "Groundwater", "Reclaimed Water", "Saline Surface Water", "Augmented" };
        // Sampson edits 08.18.18
        static public string[] ResourceListLabel = new string[] { "Surface Water", "Surface Water Lake ", "Groundwater", "Recycled Water", "Saline Surface Water", "Augmented" };
    ...
    public struct RateData
    {
        ...
        public RateData(string aUnitName, string aUnitCode, double anAgRate, double anIndRate, double aPopRate, double anAgNet,
                       double anAgRateLCLU, double anUrbanRateLCLU, double anIndRateLCLU)
        {
            bool isErr = false;
            string errMsg = "";
