...
var IndSetupData = {
    ECOR: {
        filenames: ['./Assets/indicators/Latest_Images/economy_0.jpg', './Assets/indicators/New_Images/economy_flat_white.jpg', './Assets/indicators/New_Images/economy_flat_grey_color.jpg', './Assets/indicators/New_Images/economy.jpg'],
        title: 'Economy'
    },
    ENVIND: {
        filenames: ['./Assets/indicators/Latest_Images/environment_0.jpg', './Assets/indicators/New_Images/environment_flat_white.jpg', './Assets/indicators/New_Images/environment_flat_grey_color.jpg', './Assets/indicators/New_Images/environment.jpg'],
        title: 'Environment'
    },
    SWI: {
        filenames: ['./Assets/indicators/Latest_Images/environment_0.jpg', './Assets/indicators/New_Images/surfacewater_flat_white.jpg', './Assets/indicators/New_Images/surfacewater_flat_grey_color.jpg', './Assets/indicators/New_Images/surfacewater.jpg'],
        title: 'Surface Water'
    },
    GWSYA: {
        filenames: ['./Assets/indicators/Latest_Images/groundwater_0.jpg', './Assets/indicators/New_Images/groundwater_flat_white.jpg', './Assets/indicators/New_Images/groundwater_flat_grey_color.jpg', './Assets/indicators/New_Images/groundwater.jpg'],
        title: 'Groundwater'
    },
    UEF: {
        filenames: ['./Assets/indicators/Latest_Images/cities_0.jpg', './Assets/indicators/New_Images/urbanefficiency_flat_white.jpg', './Assets/indicators/New_Images/urbanefficiency_flat_grey_color.jpg', './Assets/indicators/New_Images/urbanefficiency.jpg'],
        title: 'Cities & Townspeople'
    },
    PEF: {
        filenames: ['./Assets/indicators/New_Images/power_button_grey.jpg', './Assets/indicators/New_Images/power_flat_white.jpg', './Assets/indicators/New_Images/power_flat_grey_color.jpg', './Assets/indicators/New_Images/power.jpg'],
        title: 'Power Efficiency'
    },
    AGIND: {
        filenames: ['./Assets/indicators/Latest_Images/farming_0.jpg', './Assets/indicators/New_Images/agriculture_flat_white.jpg', './Assets/indicators/New_Images/agriculture_flat_grey_color.jpg', './Assets/indicators/New_Images/agriculture.jpg'],
        title: 'Farming'
    },
...
function IndicatorControl(divId, anIndicatorType, ControlId, options, showMeterInfo, hideTitle) {
   ...
   //  defWidth: 225,
    ...
    //this.divObj.hover(function () {
    //    console.log(this, this.dataset.fld)
    //    $("#speechBubble").empty();
    //    $("#speechBubble").html(
    //        '<p style="font-size: 24px;"><strong>' + HelpInfo[this.dataset.fld].name + '</strong> Click on the control to view help.</p>'
    //    );
    ...
    //    $("#speechBubble").empty();
    //    $("#speechBubble").html(
    //        '<p style="font-size: 24px;"><strong>' + HelpInfo[this.dataset.fld].name + '</strong> ' +
    //        HelpInfo[this.dataset.fld].description + '</p>'
    //    );
    //    $("#speechBubble").fadeIn(500);
    //});
    ...
    this.showTitle = hideTitle ? false : true;
    // QUAY EDIT 3/19/16 end
...
function drawImage(IndControl,canvas,dims, src, values) {
    if (canvas.getContext) {
        var ctx = canvas.getContext('2d');
        var img = new Image();
        var drawTitle = IndControl.showTitle;
        ...
        img.onload = function () {
            ctx.drawImage(img, x, y, indicatorDims.width, indicatorDims.height - 40);
            // QUAY EDIT 3/19/16 begin
...
function drawText(canvas, dims, title) {
  if (canvas.getContext){
   ...
   // var y = canvasHeight - border - textHeight;
    ...
    ctx.font = fontInt + "px Helvetica, sans-serif";
