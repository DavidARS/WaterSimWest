...
var IndSetupData = {
    ...
    PEF_P: {
        ...
        //          <path class="power-gear" d="M53.16,29.985a10.615,10.615,0,0,0-.123-1.974H60.07A12.542,12.542,0,0,0,47.977,15.424a18.243,18.243,0,0,0-3.085-3.085L49.828,7.4a12.522,12.522,0,0,0-17.4-.37,14.933,14.933,0,0,0-2.345-.123,10.615,10.615,0,0,0-1.974.123V0A12.542,12.542,0,0,0,15.524,12.093a18.243,18.243,0,0,0-3.085,3.085L7.5,10.242a12.522,12.522,0,0,0-.37,17.4,14.933,14.933,0,0,0-.123,2.345,10.615,10.615,0,0,0,.123,1.974H.1A12.542,12.542,0,0,0,12.193,44.546a18.243,18.243,0,0,0,3.085,3.085l-4.936,4.936a12.522,12.522,0,0,0,17.4.37,14.934,14.934,0,0,0,2.345.123,10.615,10.615,0,0,0,1.974-.123V59.97A12.542,12.542,0,0,0,44.646,47.877a18.243,18.243,0,0,0,3.085-3.085l4.936,4.936a12.522,12.522,0,0,0,.37-17.4C53.037,31.589,53.16,30.849,53.16,29.985Z" transform="translate(0 0)"/> \
        //          <path class="power-lightning" d="M36.366,14.2H29.95c-.123,0-.123,0-.123.123L16.87,28.39a.236.236,0,0,0,.123.37h5.429a.236.236,0,0,1,.123.37l-6.54,9.748c-.123.247.123.494.37.247L36.12,22.591c.123-.123.123-.37-.123-.37H29.95c-.247,0-.247-.247-.123-.37l6.787-7.28C36.737,14.447,36.613,14.2,36.366,14.2Z" transform="translate(4 4)"/> \
        //        </g> \
        //        <g transform="translate(0 27)"> \
        //          <path class="power-water" d="M0,55.036s10.612-3.825,23.815,1.111C33.687,59.972,44.669,63.18,59.23,50.1a61.709,61.709,0,0,1-16.288,5.429c-7.774,1.357-18.386-3.455-26.283-4.936C10.118,49.483,0,55.036,0,55.036Z" transform="translate(0 0)"/> \
        //          <path class="power-water" d="M.9,59.936s10.612-3.825,23.815,1.111C34.587,64.872,45.569,68.08,60.13,55a61.709,61.709,0,0,1-16.288,5.429c-7.774,1.357-18.386-3.455-26.283-4.936C10.9,54.383.9,59.936.9,59.936Z" transform="translate(0 1)"/> \
        //        </g> \
        //      </g>',
        title: 'Electricity'
    },
    ...
    rgr_meter: '<g class="meter-rgr" transform="translate(155 18)" style="border: 1px solid black;"> \
    ...
    svg_close: '</svg>',
    rg_g: '<g class="main-g" transform="translate(2934 -31)">',
    ...
    rg_currentValue: '<g class="indicator-value-current-rg" transform="translate(806 270)"> \
                        ...
                        <text data-name="80" class="indicator-value-current-text" transform="translate(17 15)"> \
                            <tspan x="0" y="0">80%</tspan> \
                        </text> \
                    </g>',
    rg_previousValue: '<g class="indicator-value-previous-rg" transform="translate(806 270)"> \
                        ...
                        <path class="indicator-value-background" d="M90.9,24.5H60.751A.762.762,0,0,1,60,23.74V7.26a.762.762,0,0,1,.751-.76H90.9a.762.762,0,0,1,.751.76V23.717A.768.768,0,0,1,90.9,24.5Z" transform="translate(-46.5 -5)" /> \
                        <text data-name="80" class="indicator-value-previous-text" transform="translate(17 15)"> \
                            <tspan x="0" y="0">80%</tspan> \
                        </text> \
                    </g>',
    ...
    rgr_currentValue: '<g class="indicator-value-current-rgr" transform="translate(1309 -2.5)"> \
                        <text class="indicator-value-current-text" transform="translate(232 354)" text-anchor="middle"><tspan x="0" y="0">0%</tspan></text> \
    ...
    rgr_previousValue: '<g class="indicator-value-previous-rgr" transform="translate(1309 -2.5)"> \
                        <text class="indicator-value-previous-text" transform="translate(232 369)" text-anchor="middle"><tspan x="0" y="0">0%</tspan></text> \
...
function IndicatorControl(divId, anIndicatorType, ControlId, options) {
    ...
    this.resize = function (width, height) {
        console.log('IndicatorControl (width, height): ' + width + ', ', height)
    }
...
function PrepareIndicator(indControl) {
    ...
    htmlInd += IndSetupData[indControl.IndicatorType].svg;
...
function DrawIndicator(indControl) {
    ...
    if (indControl.meter == 'rg') {
        indControl.cValObj.attr('transform', 'translate(806 ' + indControl.scale(indControl.value) + ')');
        indControl.cValTspanObj.text(Math.round(indControl.value) + '%');

        if (indControl.drawOldValue) {
            indControl.pValObj.attr('transform', 'translate(806 ' + indControl.scale(indControl.value_old) + ')');
            indControl.pValTspanObj.text(Math.round(indControl.value_old) + '%');
