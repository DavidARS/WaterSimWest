...
function drawDrillDownChartBO(jsonData, controlID, subControls, fldLabName, fldValue, strtYr, endYr, index, Min, Max, Units, seriescolors, chartTypeCode) {
    ...
    var MyFillOpacity = 1;
    var isStacked = false;
    var lineColors = ['#000000', '#FF0000','#336600'];
    // Default
    var seriesColors = ["#7cb5ec", "#f7a35c", "#90ee7e", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee",
 ...
 //       Ymax = JudgeMax(flds,Max,false)
    ...
    $.each(flds, function () {
        ...
        // build charts data
        if ((MyDataChartType == ChartTypeLine) || (MyDataChartType == ChartTypeArea)) {
            ...
            if (MyDataChartType = ChartTypeColumn) {
