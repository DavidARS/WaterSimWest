...
// Draw Chart Function
// Version 2
// Substantial Changes here  3/15/14
// ===============================================
...
function drawChart(controlID) {
    ...
    var TimeMode = "";
    var seriesColors = ["#2b908f", "#90ee7e", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee",
    ...
    switch (MainType) {
            ...
            if (strtYr == endYr) {
                ...
                switch (SubType) {
                    case "":
                        ...
                        drawProvidersChart(jsondata, controlID, subControls, fldNames, fldValues, providerName, strtYr, endYr, (strtYr - $jsonObj.MODELSTATUS.STARTYEAR), fldMINes, fldMAXes, fldLongunits, ChartTypeAreaStacked);
                        break;
                    case "L":
                        ...
                        drawProvidersChart(jsondata, controlID, subControls, fldNames, fldValues, providerName, strtYr, endYr, (strtYr - $jsonObj.MODELSTATUS.STARTYEAR), fldMINes, fldMAXes, fldLongunits,ChartTypeLine);
                        break;
                }
            }
            break;
        case "MFOP":
            ...
            if (strtYr == endYr) {
                ...
                drawProvidersChart(jsondata, controlID, subControls, fldNames, fldValues, CurrentProvider, strtYr, endYr, (strtYr - $jsonObj.MODELSTATUS.STARTYEAR), fldMINes, fldMAXes, fldLongunits, ChartTypeColumnStacked);
